	...
	*/
	...
	applets: [
		...
		NANDFlashApplet {
			...
			mailboxAddr: 0x220004
			entryAddr: 0x220000
			nandHeaderHelp: "For information on the NAND header values, please refer to Boot Strategies chapter from SAMA5D2 datasheet."
		},
		SDMMCApplet {
		...
		SetGPIOApplet {
            codeUrl: Qt.resolvedUrl("applets/applet-setgpio_sama5d2-generic_sram.bin")
			codeAddr: 0x220000
			mailboxAddr: 0x220004
			entryAddr: 0x220000
		}
